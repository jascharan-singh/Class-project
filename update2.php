...
<div class="container">
    ...
    <div class="input1">
    <label for="username">USERNAME:</label> <input type="text" id = "username" name = "username" value = "<?php echo $data[1] ['Username'];?>">
    <br>
    <br>
    <label for="password">PASSWORD:</label> <input type="text" id = "password" name = "password" value = "<?php echo $data[1] ['Password'];?>" >
    <br>
    <br>
    <label for="conpassword">CON-PASS:</label> <input type="text" id = "conpassword" name = "Compassword" value = "<?php echo $data[1] ['ConPassword'];?>">
    <br>
    <br>
    <label for="Email">EMAIL:</label> <input type="text" id = "Email" name = "email" value = "<?php echo $data[1] ['Email'];?>">
    <br>
    <br>
</div >
